...
def _gradient_checkpointing_enable(
    ...
    if "value" in inspect.signature(self._set_gradient_checkpointing).parameters:  # old GC format
        ...
        logger.info("You are using the old GC format, some features (e.g. BAdam) will be invalid.")
...
def prepare_model_for_training(model: "PreTrainedModel", model_args: "CustomizedArguments") -> None:
